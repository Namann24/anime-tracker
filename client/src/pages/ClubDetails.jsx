    ...
    return (
        <div className="min-h-screen pt-32 pb-24 px-6 md:px-12 transition-colors duration-500 saga-animate-in">
            <div className="max-w-[1200px] mx-auto">
                ...
                {/* HERO HEADER */}
                <div className="relative rounded-[3rem] overflow-hidden mb-16 border border-[var(--saga-border)] bg-[var(--saga-surface)]">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-red-600/5 blur-[100px] -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                    ...
                    <div className="relative p-10 md:p-16 flex flex-col md:flex-row items-center gap-12">
                        <div className="relative group">
                            ...
                            <div className="w-32 h-32 md:w-48 md:h-48 rounded-[2.5rem] overflow-hidden border-2 border-red-600/30 shadow-[0_0_50px_rgba(255,0,60,0.1)] relative">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <h1 className="text-shonen-bold text-6xl md:text-8xl mb-4 tracking-tighter leading-none uppercase">{club.name}</h1>
                        ...
                        <div className="md:ml-auto flex flex-col gap-4 items-center md:items-end">
                    ...
                    {discussions.length === 0 ? (
                        ...
                        discussions.map(topic => {
                            ...
                            return (
                                <div
                                    key={topic._id}
                                    className={`saga-glass rounded-[2.5rem] transition-all duration-500 overflow-hidden ${isExpanded ? "ring-2 ring-red-600/30 -translate-y-2 shadow-[0_20px_60px_rgba(255,0,60,0.1)]" : "hover:border-red-600/30"}`}
                                >
                                    {/* CARD HEADER */}
                                    <div className="p-10 cursor-pointer group" onClick={() => toggleExpand(topic._id)}>
                                        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                                            <div className="flex-1 pr-4">
                                                ...
                                                <h3 className="text-shonen-bold text-4xl mb-4 tracking-tighter uppercase leading-none group-hover:text-red-500 transition-colors">
                                                    {topic.title}
                                                </h3>
                                                <p className="text-[var(--saga-text-dim)] font-medium italic opacity-60 leading-relaxed mb-8 max-w-4xl">
                                                    {topic.content}
                                                </p>

                                                {/* POLL SECTION */}
                                                {topic.poll && topic.poll.options?.length > 0 && (
                                                    <div className="mb-8 p-8 bg-black/5 rounded-[2rem] border border-[var(--saga-border)]">
                                                        <h4 className="text-[10px] font-black text-red-600 uppercase tracking-[0.4em] mb-8 flex items-center gap-4">
                                                        ...
                                                        <div className="space-y-4">
                                                            {topic.poll.options.map((opt, idx) => {
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        <div className="h-12 w-full bg-black/20 rounded-2xl overflow-hidden border border-[var(--saga-border)] relative">
                                                                            <div
                                                                            ...
                                                                            <div className="absolute inset-0 px-6 flex items-center justify-between">
                                                                                <div className="flex items-center gap-3 overflow-hidden">
                                                                                    ...
                                                                                    <span className={`text-xs font-black uppercase tracking-widest truncate ${hasVoted ? 'text-red-600' : 'text-gray-400'}`}>
                                                                                        {opt.text}
                                                                                    </span>
                                                                                </div>
                                                                                <div className="flex items-center gap-4">
                                                                                    <span className="text-[9px] font-black text-gray-500 uppercase tracking-tighter">{voteCount} Bonds</span>
                                            ...
                                            <button
                                                ...
                                                className={`flex flex-col items-center gap-2 p-4 rounded-3xl min-w-[80px] transition-all duration-300 border-2 ${isLiked
                                            ...
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={isLiked ? "currentColor" : "none"} stroke="currentColor" strokeWidth={isLiked ? "0" : "3"} className="w-8 h-8">
                                                ...
                                                <span className="font-black text-sm tracking-widest">{topic.likes.length}</span>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    {/* COMMENTS SECTION */}
                                    {isExpanded && (
                                        <div className="bg-black/10 border-t border-[var(--saga-border)] p-10 animate-in slide-in-from-top-4 duration-500">
                                            <div className="flex items-center gap-4 mb-10">
                                                <span className="w-8 h-[2px] bg-red-600"></span>
                                                <h4 className="text-shonen-bold text-2xl uppercase tracking-tighter">Archival Echoes ({topic.comments.length})</h4>
                                            </div>
                                            ...
                                            <div className="space-y-6 mb-12">
                                                {topic.comments.length === 0 ? (
                                                    ...
                                                    topic.comments.map((comment, idx) => (
                                                        <div key={idx} className="flex gap-6 group/comment">
                                                            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-red-600 to-black text-white flex items-center justify-center font-black text-sm shadow-xl flex-shrink-0 border border-white/10 uppercase italic">
                                                                {comment.author?.username?.[0] || "?"}
                                                            </div>
                                                            <div className="flex-1">
                                                                <div className="bg-white/5 p-6 rounded-[2rem] rounded-tl-none border border-white/5 group-hover/comment:border-white/10 transition-colors">
                                            ...
                                            {user && (
                                                <form onSubmit={(e) => handleCommentSubmit(e, topic._id)} className="flex gap-4 items-center pl-16">
                                                    <div className="flex-1 relative">
                                                        <input
                                                            id={`reply-${topic._id}`}
                                                            type="text"
                                                            placeholder="Echo your thoughts into the archive..."
                                                            className="w-full bg-black/20 border border-[var(--saga-border)] rounded-full px-8 py-4 outline-none focus:border-red-600/50 text-sm font-medium transition-all text-white placeholder:text-gray-600 italic"
                                                            value={newComment}
                ...
                {showModal && (
                    <div className="fixed inset-0 bg-black/80 backdrop-blur-xl z-[100] flex items-center justify-center p-6 sm:p-12 animate-in fade-in zoom-in duration-300">
                        <div className="bg-[var(--saga-surface)] border border-[var(--saga-border)] rounded-[3rem] p-10 md:p-16 w-full max-w-3xl relative overflow-hidden shadow-[0_0_100px_rgba(255,0,60,0.1)]">

                            <button onClick={() => setShowModal(false)} className="absolute top-8 right-8 text-gray-500 hover:text-white transition-colors" title="Seal Manifest">
                            ...
                            <div className="mb-12">
                                ...
                                <h2 className="text-shonen-bold text-5xl md:text-6xl tracking-tighter uppercase leading-none">Initiate <span className="text-red-600">Manifesto</span></h2>
                            </div>
                            ...
                            <form onSubmit={handleCreate} className="space-y-8">
                                ...
                                {/* POLL FORM */}
                                {showPollForm && (
                                    <div className="space-y-6 p-10 bg-red-600/5 border border-red-600/20 rounded-[2.5rem] animate-in slide-in-from-top-4 duration-500">
                                        <div className="space-y-2">
                                ...
                                <div className="flex gap-4 pt-8 border-t border-[var(--saga-border)]">
