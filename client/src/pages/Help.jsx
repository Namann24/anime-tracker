    ...
    return (
        <div className="min-h-screen bg-[var(--saga-bg)] text-[var(--saga-text)] pb-24 overflow-x-hidden transition-colors">
            <div className="max-w-[1000px] mx-auto px-6 pt-32">
                <header className="text-center mb-24 relative overflow-hidden">
                    ...
                    <h1 className="text-shonen-bold text-6xl md:text-8xl mb-6 uppercase tracking-tighter leading-none">
                        Archive <span className="text-red-600">Scrolls</span>
                    </h1>
                    <p className="text-gray-500 italic max-w-xl mx-auto">"Ancient wisdom for the modern chronicler. Everything you need to navigate the saga."</p>
                </header>

                <div className="space-y-16">
                    {/* GETTING STARTED */}
                    <section className="bg-[var(--saga-surface)] p-12 border border-[var(--saga-border)] rounded-[2.5rem] relative group">
                        ...
                        <h2 className="text-shonen-bold text-3xl mb-8 uppercase tracking-tighter">Path of the Initiate</h2>
                    ...
                    <section className="bg-[var(--saga-surface)] p-12 border border-[var(--saga-border)] rounded-[2.5rem] relative group">
                        ...
                        <h2 className="text-shonen-bold text-3xl mb-8 uppercase tracking-tighter">The Aura System</h2>
                        <div className="space-y-6 text-gray-500 leading-relaxed font-medium">
                    ...
                    {/* FEEDBACK FORM */}
                    <section className="bg-[var(--saga-surface)] p-12 border border-[var(--saga-border)] rounded-[2.5rem] relative">
                        <div className="flex items-center gap-4 mb-10">
                            <div className="w-1.5 h-8 bg-red-600 rounded-full shadow-impact"></div>
                            <h2 className="text-shonen-bold text-3xl uppercase tracking-tighter">Etch a Message</h2>
                        </div>
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full p-6 bg-black/5 border border-[var(--saga-border)] rounded-[24px] text-[var(--saga-text)] outline-none focus:border-red-600/50 transition-all min-h-[160px] text-sm resize-none"
                    ...
                    <section className="text-center py-12">
                        <div className="w-12 h-px bg-[var(--saga-border)] mx-auto mb-10"></div>
                        <h2 className="text-shonen-bold text-4xl mb-6 uppercase tracking-tighter">Seek a Mentor?</h2>
                        <p className="text-gray-500 mb-12 italic max-w-lg mx-auto">"If the scrolls do not contain your answer, reach out through the feedback channels above."</p>
