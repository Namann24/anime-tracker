                ...
                <div className="relative mb-24 group">
                    ...
                    <div className="relative flex flex-col md:flex-row md:items-end justify-between gap-8 pt-8">
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-red-600/30 bg-red-600/5 text-red-500 text-[10px] font-black uppercase tracking-[0.4em] mb-8 animate-in fade-in slide-in-from-left-4 duration-700">
                                <div className="relative flex items-center justify-center">
                                    <span className="w-2 h-2 rounded-full bg-red-600 shadow-neon-red"></span>
                                    <span className="absolute w-4 h-4 rounded-full border border-red-600 animate-signal-pulse"></span>
                                </div>
